...
{
	popup();
	text.innerHTML = 'HEE YOU!!, come back here.. you didnt\'t pay the bills yet..';
	setTimeout(function()
	{
		street();
	}, 3000);
...
function exit()
{
    ...
    image.src = 'img/bg/emergencyExit.jpg';
		...
		nav1.style.top = '85px';
		nav1.style.left = '482px';
		nav1.src = 'img/item/exitDoor.png';
    nav1.setAttribute('onclick', 'caught()');

		nav2.style.top = '20px';
		nav2.style.left = '20px';
		nav2.src = 'img/item/receptionBoard.png';
    nav2.setAttribute('onclick', 'reception()');
}
